...
"""
def palsu():
	palsu = "import os,sys,time,random\n\nprint('')"
...
def bad__marshal__cythonize(__________, ___________):
...
def bad__gateway__malware(_____________):
...
#        output_file.write((Obfuscator(___infos)))
        for i in range(2):
